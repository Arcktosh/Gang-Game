import { listCraftingProfile, runCraftingAction } from '@drugdeal/db';
import { craftingActionSchema, craftingProfileQuerySchema } from '@drugdeal/validators';
...
export async function POST(request: NextRequest) {
  return withApiObservability(request, async () => {
    ...
    const body = await parseJsonBody(request, craftingActionSchema);
