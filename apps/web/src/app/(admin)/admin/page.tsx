import { getModerationTransparencySummary, listAdminAnnouncements, listAdminAudit, listAdminLoanExposure, listGameConfig, listModerationQueue } from '@drugdeal/db';
...
export default async function AdminPage() {
  ...
  const [config, audit, announcements, moderation, moderationArchive, transparency, loanExposure] = await Promise.all([
  ...
  return (
    <main className="admin-page" aria-labelledby="admin-title">
      ...
      <AdminPanel config={config} audit={audit} announcements={announcements} moderation={moderation} moderationArchive={moderationArchive} transparency={transparency} loanExposure={loanExposure} />
    </main>
  );
}
