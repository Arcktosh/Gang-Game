...
const features = [
  [
    'Persistent economy',
    'Jobs, markets, shops, finance, contracts, and inventory systems stay connected across sessions.',
  ],
  [
    'Strategic character growth',
    'Train stats, study courses, earn achievements, claim objectives, and build prestige over seasons.',
  ],
  [
    'Social world systems',
    'Faction territory, messaging, newspaper posts, PvP, bounties, and moderation tools are ready for live play.',
  ],
] as const;
      ...
      <section className="site-hero">
        <div className="site-hero__grid">
          <div className="site-hero__copy">
            ...
            <h1 className="site-hero__title" id="home-title">
              DrugDeal Game
            </h1>
            <p className="lead">
              A modern text-based multiplayer game shell with character progression, crews, markets,
              travel, messaging, moderation, seasons, and live economy loops.
            </p>
            ...
            <div className="site-hero__metrics" aria-label="Game systems summary">
              ...
              <div className="site-metric">
                <strong>Live</strong>
                <span>economy-ready systems</span>
              </div>
              <div className="site-metric">
                <strong>Seasonal</strong>
                <span>progression loops</span>
              </div>
            </div>
          </div>
